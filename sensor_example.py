...
class Robot:
    ...
    def recalc_sensor(self):
        ...
        logger.info(f"Sonar dist {d_measure}")
    ...
    def turn(self, ang):
        ...
        logger.info(f"I think I am at ({self.loc[0]}, {self.loc[1]}), orientation {rad_to_deg(self.loc[2])} degrees")
        logger.info(f"I am going to turn {ang} degrees")
    ...
    def forward(self, dist):
        ...
        logger.info(f"I think I am at ({self.loc[0]}, {self.loc[1]}), orientation {rad_to_deg(self.loc[2])} degrees")
        logger.info(f"I am going forward {dist} cm")
